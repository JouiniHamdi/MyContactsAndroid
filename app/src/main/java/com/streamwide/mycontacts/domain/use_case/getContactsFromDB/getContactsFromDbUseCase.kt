package com.streamwide.mycontacts.domain.use_case.getContactsFromDB
...
class GetContactsFromDbUseCase @Inject constructor(
    private val repository: ContactRepository
) {
    operator fun invoke() : Flow<List<UserContact>> {
        return   repository.getContactsFromDb()
    }
}